...
void Chassis::print_motor_temps() {
  ...
  pros::screen::print(pros::text_format_e_t::E_TEXT_MEDIUM, 8, "Fw: %i   In: %i   B: %i%",
                       (int) flywheel.get_motors().at(0).get_temperature(), (int) intake.get_temperature(), (int) pros::battery::get_capacity());
}
...
void Chassis::draw_field_graphic() {
  ...
  //Draw vertical auton lines
  pros::screen::set_pen(COLOR_WHITE);
  pros::screen::fill_rect(FIELD_CENTER_X - 1, FIELD_TOP_EDGE, FIELD_CENTER_X + 1, FIELD_BOTTOM_EDGE); //Thick center line
  pros::screen::draw_line(FIELD_CENTER_X - 16, FIELD_TOP_EDGE, FIELD_CENTER_X - 16, FIELD_CENTER_Y); //Thin line on top left
  pros::screen::draw_line(FIELD_CENTER_X + 16, FIELD_BOTTOM_EDGE, FIELD_CENTER_X + 16, FIELD_CENTER_Y); //Thin line on bottom right

  //Draw thick horizontal center bar and vertical offshoot bars
  pros::screen::set_pen(COLOR_BLACK);
  pros::screen::fill_rect(FIELD_LEFT_EDGE + 32, FIELD_CENTER_Y - 1, FIELD_RIGHT_EDGE - 32, FIELD_CENTER_Y + 1); //Main horizontal bar
  pros::screen::fill_rect(FIELD_LEFT_EDGE + 31, FIELD_CENTER_Y - 32, FIELD_LEFT_EDGE + 33, FIELD_CENTER_Y + 32); //Left vertical bar
  pros::screen::fill_rect(FIELD_RIGHT_EDGE - 31, FIELD_CENTER_Y - 32, FIELD_RIGHT_EDGE - 33, FIELD_CENTER_Y + 32); //Right vertical bar

  //Draw thick horizontal elevation bars and thick diagonal match load bars - BLUE
  pros::screen::set_pen(COLOR_BLUE);
  pros::screen::fill_rect(FIELD_LEFT_EDGE + 1, FIELD_CENTER_Y - 1, FIELD_LEFT_EDGE + 33, FIELD_CENTER_Y + 1); //Blue elevation bar on left
  for (int i = 0; i < 3; i++) {
    pros::screen::draw_line(FIELD_LEFT_EDGE + 1, FIELD_TOP_EDGE + 31 + i, FIELD_LEFT_EDGE + 31 + i, FIELD_TOP_EDGE + 1); //Top left blue match load
    pros::screen::draw_line(FIELD_RIGHT_EDGE - 1, FIELD_TOP_EDGE + 31 + i, FIELD_RIGHT_EDGE - 31 - i, FIELD_TOP_EDGE + 1); //Top right blue match load
  }

  //Draw thick horizontal elevation bars and thick diagonal match load bars - RED
  pros::screen::set_pen(COLOR_RED); 
  pros::screen::fill_rect(FIELD_RIGHT_EDGE - 1, FIELD_CENTER_Y - 1, FIELD_RIGHT_EDGE - 33, FIELD_CENTER_Y + 1); //Red elevation bar on right
  for (int i = 0; i < 3; i++) {
    pros::screen::draw_line(FIELD_LEFT_EDGE + 1, FIELD_BOTTOM_EDGE - 31 - i, FIELD_LEFT_EDGE + 31 + i, FIELD_BOTTOM_EDGE - 1); //Bottom left red match load
    pros::screen::draw_line(FIELD_RIGHT_EDGE - 1, FIELD_BOTTOM_EDGE - 31 - i, FIELD_RIGHT_EDGE - 31 - i, FIELD_BOTTOM_EDGE - 1); //Bottom right red match load
  }

  //Draw colored goal corner supports and vertical goal edges
  pros::screen::set_pen(COLOR_BLUE);
  pros::screen::fill_circle(FIELD_CENTER_X - 32, FIELD_BOTTOM_EDGE - 32, 6); //Bottom left blue circle
  pros::screen::fill_circle(FIELD_CENTER_X + 32, FIELD_BOTTOM_EDGE - 32, 6); //Bottom right blue circle
  pros::screen::fill_rect(FIELD_CENTER_X - 32, FIELD_BOTTOM_EDGE - 32, FIELD_CENTER_X + 32, FIELD_BOTTOM_EDGE); //Blue goal edges

  pros::screen::set_pen(COLOR_RED);
  pros::screen::fill_circle(FIELD_CENTER_X - 32, FIELD_TOP_EDGE + 32, 6); //Top left red circle
  pros::screen::fill_circle(FIELD_CENTER_X + 32, FIELD_TOP_EDGE + 32, 6); //Top right red circle
  pros::screen::fill_rect(FIELD_CENTER_X - 32, FIELD_TOP_EDGE + 32, FIELD_CENTER_X + 32, FIELD_TOP_EDGE); //Red goal edges
  
  //Draw black goal nets on top of colored goal edges
  pros::screen::set_pen(COLOR_BLACK);
  pros::screen::fill_rect(FIELD_CENTER_X - 30, FIELD_BOTTOM_EDGE - 32, FIELD_CENTER_X + 30, FIELD_BOTTOM_EDGE); //Bottom goal net
  pros::screen::fill_rect(FIELD_CENTER_X - 30, FIELD_TOP_EDGE + 32, FIELD_CENTER_X + 30, FIELD_TOP_EDGE); //Top goal net

  //Draw inside of red goal with a lighter color
  pros::screen::set_pen(COLOR_SALMON);
  pros::screen::fill_rect(FIELD_CENTER_X - 28, FIELD_TOP_EDGE + 30, FIELD_CENTER_X + 28, FIELD_TOP_EDGE);

  //Draw inside of blue goal with a lighter color
  pros::screen::set_pen(COLOR_LIGHT_SKY_BLUE);
  pros::screen::fill_rect(FIELD_CENTER_X - 28, FIELD_BOTTOM_EDGE - 30, FIELD_CENTER_X + 28, FIELD_BOTTOM_EDGE);

  //Redraw top and bottom field walls where covered by goal
  pros::screen::set_pen(COLOR_WHITE);
  pros::screen::draw_line(FIELD_CENTER_X - 32, FIELD_BOTTOM_EDGE, FIELD_CENTER_X + 32, FIELD_BOTTOM_EDGE); //Bottom line
  pros::screen::draw_line(FIELD_CENTER_X - 32, FIELD_TOP_EDGE, FIELD_CENTER_X + 32, FIELD_TOP_EDGE); //Top line
}
