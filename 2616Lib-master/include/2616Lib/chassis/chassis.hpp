...
class Chassis {
  public:
    ...
    void drive(Point point, float speed);
    ...
    void move_to_point(Point point, float speed);
    void move_to_point(double xcoord, double ycoord, float speed);
    ...
    void motion_profiling(std::vector<Point> path, double final_angle, double tangent_magnitude, double v, double a, double w);
